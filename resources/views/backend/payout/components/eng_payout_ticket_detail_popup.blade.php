<div class="grid grid-cols-12 gap-4">
    <div class="col-span-6 space-y-7">
        ...
        <!-- <div class="text-gray-700 shadow-md border border-gray-300 rounded-lg p-6 bg-white">
            ...
            <div class="grid grid-cols-4 items-start  mb-6 gap-2">
                ...
                <div class="flex flex-col">
                    ...
                    <strong class="font-semibold text-nowrap text-md cursor-pointer" title="{{ $ticket_works['ticket']->task_name }}">
        ...
        @include('backend.modal_components.engineer_customer_payout-block', ['ticket_works' => $ticket_works])
        ...
        <div>
            ...
            <div class="flex flex-row gap-12 mt-1 p-1">
                ...
                <div class="flex flex-col">
                    <span class="text-sm text-gray-500">Agreed Rate</span>
                    <strong class="font-semibold text-md">{{ $engineerCurrency}} {{ $ticket->engineer_agreed_rate ?? 0}}</strong>
                </div>
                @endif
                ...
                <table class="w-full border-collapse border border-gray-300 rounded-lg shadow-sm">
                    ...
                    <tbody class="divide-y divide-gray-300 bg-white">
                        ...
                        <tr class="text-md hover:bg-gray-50">
                            ...
                            @else
                            <td class="py-2 px-4 text-left">{{ $label === 'Hourly Payable' && !empty($ticket->engineer_agreed_rate) ? "Agreed Rate" : $label }}</td>
                            @endif
