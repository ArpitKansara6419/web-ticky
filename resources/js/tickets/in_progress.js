...
var inprogressTable = "inprogress-table";
var inprogressDatatable = $("#" + inprogressTable).DataTable({
    processing: true,
    serverSide: true,
    searching: false,
    lengthChange: false,
...
$("#inprogress_search").on("input", function () {
    inprogressDatatable.ajax.reload();
});