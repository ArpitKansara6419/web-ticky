...
var acceptedTable = "accepted-table";
var acceptedDatatable = $("#" + acceptedTable).DataTable({
    processing: true,
    serverSide: true,
    searching: false,
    lengthChange: false,
    ...
    ajax: {
        ...
        dataType: "json",
        data: function (d) {
            var searchValue = $("#accepted_search").val();
...
$("#accepted_search").on("input", function () {
    acceptedDatatable.ajax.reload();
});
